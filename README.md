...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-shades-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1606&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-shades-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-shades` can be installed with:

```
conda install r-shades
```

It is possible to list all of the versions of `r-shades` available on your platform with:
